...
class XLerobot2WheelsConfig(RobotConfig):
    ...
    port1: str = "/dev/tty.usbmodem5B141156081"  # port to connect to the bus (so101 + head camera) /dev/tty.usbmodem5B141156081
    port2: str = "/dev/tty.usbmodem5B141120971"  # port to connect to the bus (arms + 2 wheels) /dev/tty.usbmodem5B141120971
